...
<body>
	<div id="wrap">
    	<div id="container">
						...
						<div id="innerTopHeaderMenu">
							<div id="topHeaderRight">
								...
								<?php if(Yii::app()->user->isGuest){ ?>
									...
									<div id="account">
										<ul>
											<li><?=CHtml::link('AdminCP',array('/admin'));?></li>
											<li id="divider">|</li>
									...
									<div id="profileMenu">
										<div id="profileName">
											...
											<div id="settings" class="fa fa-user"></div>
										</div>  
										<div id="menu">
											<div id="arrow"></div>
											<?php 
			...
			<?=CHtml::link('Wishlist('.$wc.') <i id="thirdIcon" class="fa fa-tags"></i>',array('/customer/default/wishlist'));?>
			<?=CHtml::link('Logout <i id="sixthIcon" class="fa fa-sign-out "></i>',array('/site/logout'));?>
									   </div>
									</div>
									<?php } ?>
