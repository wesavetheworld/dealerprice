		 	...
		 	<!-- Best Price Alert -->
										...
										<div class="overlay-bg-best-price">
											<div class="overlay-content-best-price popup1" id="bestPriceFormOverlay">
												...
												<div id="loginHeader">
													<div id="loginLeftHeader">Price too high? Get instant best price alert by Email or SMS!</div>
												</div>
												...
												<div id="infoMsg"></div>
													<div id="loginLeft">
														<form method="post" action="" id="loginForm">
															...
															<input type="email" id="alertEmailId" required="required"></label>
															<label><span>Target Price: </span>
															<input type="text" id="alertTargetPrice" required="required"></label>
															<label><span>Mobile No: </span>
															<input type="text" id="alertMobile" placeholder="Optional"></label>
													...
													<div id="loginRight">
														<div id="alertItm">
															<div id="alertItmImg">
																<img src="<?=Yii::app()->theme->baseUrl?>/images/qv_img_1.jpg"width="100" height="130"/>
															</div>
															<div id="alertItmName">
...
$(function(){
	$('#registerAlert').click(function(){
		...
		if(email && target)
		$.post(url, {email: email, target: target, mobile: mobile}, function(d){
			d = $.parseJSON(d);
			if(d.status == "success")
				$('#infoMsg').text("You have successfully registered.").css('color', 'green');
		});
		return false;
	});
