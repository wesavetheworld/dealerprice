...
class ProductdetailsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		$model->product_id=isset($_GET['pid']) ? $_GET['pid'] : '';
		...
		if(isset($_POST['ProductDetails']))
		{
			...
			if($model->save())
				$this->redirect(array('/admin/productdetails/create','pid'=>$model->product_id));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('ProductDetails');
