...
class SubCategories extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, category_id, name, url, description, status', 'safe', 'on'=>'search'),
		);
	}
	public function customUrlValidate($attr, $params)
	{
		...
		if(isset($cat) || (isset($subcat) && $subcat->id != $this->id) || isset($brands) || isset($types) || isset($product))
	...
	public function relations()
	{
		...
		return array(
				...
				'bcategory' => array(self::BELONGS_TO, 'Categories', 'category_id'),
				'tcategory' => array(self::BELONGS_TO, 'Categories', 'category_id'),
				'productTypes' => array(self::HAS_MANY, 'ProductType', 'sub_category_id'),
				'brands' => array(self::HAS_MANY, 'ProductType', 'sub_category_id'),
		);
	}
