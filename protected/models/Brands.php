...
class Brands extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, url, status', 'safe', 'on'=>'search'),
		);
	}
	public function customUrlValidate($attr, $params)
	{
		...
		if(isset($cat) || isset($subcat) || (isset($brands)  && $brands->id != $this->id) || isset($types) || isset($product) )
	...
	public function relations()
	{
		...
		return array(
				'brandssubCategory' => array(self::BELONGS_TO, 'SubCategories', 'sub_category_id'),
