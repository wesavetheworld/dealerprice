                                    ...
                                    <div class="product_preview">
                                        ...
                                        <div class="owl_carousel" id="thumbnails">
                                            ...
                                            <a href="#" data-image="<?=$img->normal?>" data-zoom-image="<?=!empty($img->zoom) ?  $img->zoom : $img->normal?>">
                                                ...
                                                <img src="<?=$img->normal?>" data-large-image="<?=!empty($img->zoom) ?  $img->zoom : $img->normal?>" alt="">
                                ...
                                <div class="single_product_description">
                                    ...
                                    <div class="description_section v_centered">
                                        ...
                                        <ul class="topbar">
											...
											<li><a href="#" class="show-popup-best-price" data-showpopup="1">Best Price Alert</a></li>
                                    ...
                                    <hr>
									<span class="bestPriceStore <?=strpos($product->productPrice->affiliate_url, 'amazon') !== false ? 'amazon':''?> <?=strpos($product->productPrice->affiliate_url, 'flipkart') !== false ? 'flipkart':''?>"></span>
                        ...
                        <div id="itmContentTwoRight">
							...
							<section class="section_offset">
								...
								<?php
									...
									$q->limit=9;
									$q->order ="RAND()";
									$q->condition = '(brands.id ='.$product->brands->id. ' OR types.id = '.$product->types->id.')';
									$q->together = true;
									$q->alias="products";
									$q->with = array('types', 'brands', 'productDetails');
									$tempproducts = Products::model()->findAll($q);
