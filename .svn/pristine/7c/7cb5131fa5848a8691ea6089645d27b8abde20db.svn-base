...
<?php $form=$this->beginWidget('CActiveForm', array(
                            ...
                            'enableAjaxValidation'=>true,
                                'htmlOptions'=>array(
                                    ...
                                    'onkeypress'=>" if(event.keyCode == 13){ registersend(); } "),
                            )); ?>
	...
	<div><span>Password: </span>
		<?php echo $form->passwordField($model,'password', array('id'=>'signupPwd', 'placeholder'=>'Enter Password', 'class'=>"signupPwds")); ?>
                <?php echo $form->passwordField($model,'password', array('id'=>'signupCnfPwd', 'placeholder'=>'Confirm Password', 'class'=>"signupPwds")); ?>
